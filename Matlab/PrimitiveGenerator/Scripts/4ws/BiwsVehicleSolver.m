function [path, motion] = BiwsVehicleSolver(distance_between_axes, s0, s1, movie_flag, plot_flag)
...
path =  [[start_x; s(1,2:size(s,2)-1)'; goal_x] [start_y; s(2,2:size(s,2)-1)'; goal_y] [start_theta; s(3,2:size(s,2)-1)'; goal_theta] [start_phi; s(4,2:size(s,2)-1)'; goal_phi] [-start_phi; -s(4,2:size(s,2)-1)'; -goal_phi]];
