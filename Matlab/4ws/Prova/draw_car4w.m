...
wL = L/16; % (wheel length)/2
wS = L/8; % (wheel separation)/2draw_4ws(lf,lr,x)
...
R2 = [cos(x(3)+x(5)) -sin(x(3)+x(5));
      sin(x(3)+x(5))  cos(x(3)+x(5))];   
   
p0 = R2*p0 + repmat(x(1:2),1,2);
